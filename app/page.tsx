...
import { Video, CheckCircle, AlertCircle, Loader2, Zap, Target, Flame } from "lucide-react"
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      setProcessingStatus({
        ...
        outputUrl: uploadResponse.data.detectionResult?.output_video_url || "https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/BigBuckBunny.mp4",
      })
    } catch (error) {
    ...
    <div className="min-h-screen bg-gradient-to-br from-orange-100 via-red-50 to-blue-100 p-4">
      <div className="max-w-4xl mx-auto space-y-6">
        <div className="text-center py-8">
          ...
          <p className="text-lg text-gray-700 font-medium">Launch, Battle, and Master your video content!</p>
        </div>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Select your video to enter the battle arena</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <div className="border-2 border-dashed border-gray-300 rounded-lg p-8 text-center">
              ...
              <label htmlFor="video-upload" className="cursor-pointer flex flex-col items-center gap-2">
                ...
                <span className="text-lg font-medium text-gray-700">Click to launch your video into battle</span>
                <span className="text-sm text-gray-500">Supports MP4, MOV, AVI - All formats ready for battle!</span>
              </label>
            </div>
            ...
            <CardContent className="space-y-4">
              ...
              {processingStatus.status === "completed" && (
                <Alert>
                  ...
                  <AlertDescription>Video processing completed successfully!</AlertDescription>
                </Alert>
              )}
            </CardContent>
          </Card>
        ...
        {processingStatus.status === "completed" && processingStatus.outputUrl && (
          <Card>
            <CardHeader>
              ...
              <CardDescription>Your champion video is ready for download!</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="bg-black rounded-lg overflow-hidden">
                <video controls className="w-full h-auto" src={processingStatus.outputUrl}>
